  ...
  return (
    <div className="flex flex-1 flex-col items-center justify-center bg-neutral-50 dark:bg-black">
      <nav className="flex w-full max-w-[800px] items-center justify-end gap-3 px-[60px] pt-4">
        ...
        <Show when="signed-in">
          <Link
            className="h-9 cursor-pointer rounded-full border border-transparent bg-black px-4 text-sm leading-9 font-medium text-neutral-50 transition-all duration-200 hover:bg-[#383838] dark:bg-[#ededed] dark:text-black dark:hover:bg-[#ccc]"
            href="/workflows"
          >
            Workflows
          </Link>
      ...
      <main className="flex w-full max-w-[800px] flex-1 flex-col items-start justify-between bg-white px-6 py-12 min-[600px]:px-[60px] min-[600px]:py-[120px] dark:bg-black">
        ...
        <div className="flex flex-col items-start gap-4 text-left min-[600px]:gap-6">
          <h1 className="max-w-[420px] text-[32px] leading-10 font-semibold tracking-[-1.92px] text-balance text-black min-[600px]:text-[40px] min-[600px]:leading-[48px] min-[600px]:tracking-[-2.4px] dark:text-[#ededed]">
            Describe an automation. Get a workflow graph.
          </h1>
